                ...
                <div class="general-label">
                    <form action="" method="POST">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="kd_buku" class="form-control" value="BK<?php echo $edit['kd_buku'] ?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="judul" placeholder="Judul Buku" value="<?= $edit['judul'] ?>">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <select class="form-control" name="tahun">
                                    ...
                                    <?php for ($tahun = date('Y'); $tahun >= 2010; $tahun--) { ?>
                                        <option value="<?php echo $tahun; ?>" <?php echo $tahun == $edit['th_terbit'] ? 'selected':''  ?> ><?php echo $tahun; ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                            ...
                            <div class="col-sm-8">
                                <select name="pengarang" id="" class="form-control">
                                    ...
                                    <?php foreach ($pengarang as $k) : ?>
                                        <option value="<?= $k->kd_pengarang ?>" <?php echo $k->kd_pengarang == $edit['pengarang'] ? 'selected':''  ?> ><?= $k->nama_pengarang ?></option>
                                    <?php endforeach ?>
                                </select>
                            </div>
                            <div class="col-sm-2">
                            ...
                            <div class="col-sm-8">
                                <select name="penerbit" id="" class="form-control">
                                    ...
                                    <?php foreach ($penerbit as $k) : ?>
                                        <option value="<?= $k->kd_penerbit ?>"  <?php echo $k->kd_penerbit == $edit['penerbit'] ? 'selected':''  ?>  ><?= $k->nama_penerbit ?></option>
                                    <?php endforeach ?>
                                </select>
                            </div>
                            <div class="col-sm-2">
                            ...
                            <div class="col-sm-8">
                                <select name="kategori" id="" class="form-control">
                                    ...
                                    <?php foreach ($kategori as $k) : ?>
                                        <option value="<?= $k->kd_kategori ?>" <?php echo $k->kd_kategori == $edit['kategori'] ? 'selected':''  ?>  ><?= $k->nama_kategori ?></option>
                                    <?php endforeach ?>
                                </select>
                            </div>
                            <div class="col-sm-2">
