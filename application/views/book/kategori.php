    ...
    <div class="container-fluid">
        ...
        <div class="card">
            ...
            <div class="card-body bg-light">
                ...
                <table id="datatable2" class="table dt-responsive nowrap table-bordered" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                    <thead>
                        <tr>
                            <th>No</th>
                            <th>Kode </th>
                        ...
                        foreach ($kategori as $b) { ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="<?= base_url('admin/deleteKategori/') . $b->id_kategori ?>" class="btn btn-danger"><i class="fas fa-trash"></i></a>
                                </td>
                            </tr>
                        <?php } ?>
                    </tbody>
