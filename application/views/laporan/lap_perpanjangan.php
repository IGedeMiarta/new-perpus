        ...
        <div class="card">
            <div class="card-header bg-primary text-center">
             ...
             <div class="card-body">
                    ...
                    ?>
                        <a class='btn btn-danger' target="_blank" href='<?php echo base_url() . 'laporan/cetakPerpanjangan?tanggal_mulai=' . $mulai . '&tanggal_sampai=' . $sampai ?>'><i class='fas fa-file-pdf'></i> Import PDF</a>
                    <?php
                    }
                    ?>
             </div>
