                    ...
                    <tbody>
                        ...
                        foreach ($petugas as $b) { ?>
                            <tr>
                                ...
                                <td><?= $b->alamat ?></td>
                                <td>
                                    <a href="" class="btn btn-warning edit-petugas" data-toggle="modal" data-id="<?= $b->id_petugas ?>" data-target="#modelEdit"> <i class="fas fa-edit"></i></a>
                                    <a href="<?= base_url('users/deletePetugas/') . $b->id_petugas ?>" class="btn btn-danger"> <i class="fas fa-trash"></i></a>
                                </td>
                            </tr>
                            </tr>
                        <?php } ?>
