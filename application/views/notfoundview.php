                ...
                <div class="card auth-card shadow-lg">
                    <div class="card-body">
                        <div class="px-3">
                            ...
                            <!--end auth-logo-box-->
                            <img src="<?= base_url() ?>/assets/images/404.jpg" alt="" class="d-block mx-auto mt-4" height="250">
                            <div class="text-center auth-logo-text mb-4">
                                <h4 class="mt-0 mb-3 mt-5">Looks like you've got lost...</h4>
                                <a href="javascript: window.history.go(-1)" class="btn btn-sm btn-primary">Go Back</a>
                            </div>
                            <!--end auth-logo-text-->
                        </div>
                        <!--end /div-->
